...
const authoredUiText: Readonly<Record<Language, OntologyUiText>> = {
  zh: {
    title: "本体查看器",
    viewer: "查看器",
    ...
    typicalInput: "典型输入",
    typicalOutput: "典型输出",
    referenceImplementations: "参考实现与规范",
    positiveExamples: "符合定义的示例",
    counterexamples: "不符合定义或处于边界的示例",
    exampleRationale: "区分理由",
    instanceExamples: "实例说明",
    structureConstraints: "结构与约束",
    caseFragments: "主案例片段",
    sourcesAndReferences: "来源与引用",
  ...
  en: {
    ...
    title: "Ontology Viewer", viewer: "Viewer", searchPlaceholder: "domains, modules, concepts, relations, sources, cases", browseOntology: "Browse the Agent ontology hierarchy", searchOntology: "Search ontology", searchResults: "Search results", ontologyGraph: "Ontology graph", hierarchy: "Logical hierarchy and semantic relations", concepts: "Concepts", semanticRelations: "Semantic relations", structureFields: "Structure fields", domainContents: "Domain contents", ontologyScale: "Ontology scale", details: "Node and relation details", sourcesGovernance: "Sources and governance", logicalPosition: "Logical position", primaryParent: "Direct broader concept", additionalParents: "Additional broader concepts", directChildren: "Direct narrower concepts", definitionBoundary: "Definition and boundary", shortDefinition: "Short definition", formalDefinition: "Formal definition", whyNeeded: "Why this concept is needed", includes: "Includes", excludes: "Excludes", incomingRelations: "Incoming relations", outgoingRelations: "Outgoing relations", engineeringExplanation: "Engineering explanation",   typicalInput: "Typical input", typicalOutput: "Typical output", positiveExamples: "Positive examples", counterexamples: "Counterexamples and boundary cases", instanceExamples: "Instance examples", structureConstraints: "Structure and constraints",  caseFragments: "Case fragments",    showAll: (total) => `Show all (${total} items)`, showingCount: (shown, total) => `Showing ${shown} of ${total} items`, collapseList: "Collapse", focusNode: (label) => `Selected: ${label}`, focusRelation: (label) => `Selected relation: ${label}`, backToNode: "Back to node details", highlightCase: "Highlight this case in the current graph", clearCaseHighlight: "Clear case highlight", expandAdjacentNodes: (count) => `Expand adjacent nodes (+${count})`, caseNextSteps: (count) => `Next case steps (+${count})`, expandNode: "Explicitly expand next level", syntheticExample: "Synthetic example", realExample: "Real record reference", referenceExample: "Reference record", notApplicable: "Not applicable", noInformation: "No reviewed information is available for this node", organizationalNodeInstanceNote: "This Domain/Module organization node does not use instance examples", graphEmptyTitle: "Incomplete graph hierarchy data", graphEmptyBody: "The current node has no resolvable parent ownership, narrower concept, or semantic relation. Check the canonical hierarchy data.", rootRepairNotice: "The linked graph context could not contain the focus and was repaired using its canonical primary path.",  iri: "IRI", source: "Source", domains: "Domains", modules: "Modules", visibleConcepts: "Visible nodes", visibleEdges: "Visible edges", fields: "Structure fields", localFields: "Locally declared fields", inheritedFields: "Inherited fields", declaredOn: "Declared on concept", inheritanceDepth: "Inheritance depth", constraints: "Constraints", controlledValues: "Controlled values", sourceClaimCount: "Source claims", relationId: "Relation ID", relationStatement: "Relation statement", direction: "Direction", relationKind: "Relation kind", endpointRestrictions: "Endpoint restrictions", cardinality: "Cardinality", inverseReading: "Inverse reading", conditions: "Conditions", temporalScope: "Temporal scope",     identityKeys: "Identity keys", minimumJson: "Minimal JSON fragment", fieldDatatype: "Datatype", required: "Required", allowedValues: "Allowed values", pattern: "Pattern", exampleValue: "Example value",   severity: "Severity", expression: "Validation expression", expressionLanguage: "Expression language", supports: "Supported claim", locator: "Locator", authority: "Authority", priority: "Priority", year: "Year", scenario: "Scenario", previousStep: "Previous step", nextStep: "Next step",   targetConcept: "Target concept", semanticKind: "Semantic kind", applicability: "Applicability",  taxonomyContract: "Taxonomy contract",  requiredRelationConstraints: "Required relation constraints",   boundaryContext: "Boundary context", distinctFactRationale: "Distinct-fact rationale",   ontologyKind: "Ontology", planeKind: "Domain", moduleKind: "Module", conceptKind: "Concept", relationKindLabel: "Relation", buildIdentity: "Build identity", buildIdentityLoading: "Verifying build information", buildIdentityUnavailable: "Build information is temporarily unavailable", buildIdentityMismatch: "Build information does not match the bundled ontology", buildCommit: "Commit", ontologyFingerprint: "Ontology fingerprint", darkTheme: "Dark", lightTheme: "Light", downloadJson: "JSON", collapseDirectory: "Collapse", expandDirectory: "Expand directory", noSearchResults: "No ontology nodes match", derivedRelation: "Derived organization edge", canonicalRelation: "Canonical relation",
    referenceImplementations: "Reference implementations and specifications",
    exampleRationale: "Why this example is distinct",
    sourcesAndReferences: "Sources & citations",
  } as OntologyUiText,
  ja: {
    ...
    title: "本体ビューア", viewer: "ビューア", searchPlaceholder: "ドメイン、モジュール、概念、関係、出典、ケース", browseOntology: "Agent 本体階層を閲覧", searchOntology: "本体を検索", searchResults: "検索結果", ontologyGraph: "本体グラフ", hierarchy: "論理階層と意味関係", concepts: "概念", semanticRelations: "意味関係", structureFields: "構造フィールド", domainContents: "ドメイン内容", ontologyScale: "本体規模", details: "ノードと関係の詳細", sourcesGovernance: "出典とガバナンス", logicalPosition: "論理的位置", primaryParent: "直接上位概念", additionalParents: "その他の上位概念", directChildren: "直接下位概念", definitionBoundary: "定義と境界", shortDefinition: "短い定義", formalDefinition: "正式な定義", whyNeeded: "この概念が必要な理由", includes: "含む", excludes: "含まない", incomingRelations: "入ってくる関係", outgoingRelations: "出ていく関係", engineeringExplanation: "工学的説明",   typicalInput: "代表的入力", typicalOutput: "代表的出力", positiveExamples: "正例", counterexamples: "反例と境界例", instanceExamples: "インスタンス例", structureConstraints: "構造と制約",  caseFragments: "主要ケース断片",    showAll: (total) => `すべて展開（全 ${total} 件）`, showingCount: (shown, total) => `${shown} / ${total} 件を表示`, collapseList: "折りたたむ", focusNode: (label) => `選択済み：${label}`, focusRelation: (label) => `関係を選択：${label}`, backToNode: "ノード説明へ戻る", highlightCase: "現在のグラフでこのケースを強調", clearCaseHighlight: "ケース強調を終了", expandAdjacentNodes: (count) => `隣接ノードを展開（+${count}）`, caseNextSteps: (count) => `ケースの次の手順（+${count}）`, expandNode: "次の階層を明示的に展開", syntheticExample: "合成例", realExample: "実記録参照", referenceExample: "参照記録", notApplicable: "適用外", noInformation: "このノードに対応するレビュー済み情報はありません", organizationalNodeInstanceNote: "このドメイン／モジュール組織ノードにはインスタンス説明を適用しません", graphEmptyTitle: "グラフ階層データが不完全です", graphEmptyBody: "現在のノードには解決可能な上位所属、下位概念、意味関係がありません。canonical 階層データを確認してください。", rootRepairNotice: "リンクのグラフ文脈が焦点を含められないため、canonical 主経路で修復しました。",  iri: "IRI", source: "出典", domains: "ドメイン", modules: "モジュール", visibleConcepts: "表示ノード", visibleEdges: "表示エッジ", fields: "構造フィールド", localFields: "ローカル宣言フィールド", inheritedFields: "継承フィールド", declaredOn: "宣言元の概念", inheritanceDepth: "継承の深さ", constraints: "制約", controlledValues: "統制値", sourceClaimCount: "出典主張", relationId: "関係 ID", relationStatement: "関係表現", direction: "方向", relationKind: "関係種別", endpointRestrictions: "端点制限", cardinality: "基数", inverseReading: "逆方向の読み", conditions: "条件", temporalScope: "時間範囲",     identityKeys: "識別キー", minimumJson: "最小 JSON 断片", fieldDatatype: "データ型", required: "必須", allowedValues: "許容値", pattern: "パターン", exampleValue: "例の値",   severity: "重大度", expression: "検証式", expressionLanguage: "式言語", supports: "支持する主張", locator: "位置", authority: "権威種別", priority: "優先度", year: "年", scenario: "シナリオ", previousStep: "前の手順", nextStep: "次の手順",   targetConcept: "対象概念", semanticKind: "意味種別", applicability: "適用範囲",  taxonomyContract: "分類契約",  requiredRelationConstraints: "必須関係制約",   boundaryContext: "境界文脈", distinctFactRationale: "独立事実の根拠",   ontologyKind: "本体", planeKind: "ドメイン", moduleKind: "モジュール", conceptKind: "概念", relationKindLabel: "関係", buildIdentity: "ビルド識別情報", buildIdentityLoading: "ビルド情報を検証中", buildIdentityUnavailable: "ビルド情報は現在利用できません", buildIdentityMismatch: "ビルド情報が同梱された本体と一致しません", buildCommit: "コミット", ontologyFingerprint: "本体フィンガープリント", darkTheme: "暗色", lightTheme: "明色", downloadJson: "JSON", collapseDirectory: "折りたたむ", expandDirectory: "目次を展開", noSearchResults: "一致する本体ノードはありません", derivedRelation: "派生組織エッジ", canonicalRelation: "Canonical 関係",
    referenceImplementations: "参照実装と仕様",
    exampleRationale: "区別の理由",
    sourcesAndReferences: "出典と引用",
  } as OntologyUiText,
};

export const uiText: Readonly<Record<Language, OntologyUiText>> = Object.freeze({
  zh: authoredUiText.zh,
  en: authoredUiText.en,
  ja: authoredUiText.ja,
});
